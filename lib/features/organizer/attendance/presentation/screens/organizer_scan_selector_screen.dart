...
class OrganizerScanSelectorScreen extends StatefulWidget {
  ...
  @override
  State<OrganizerScanSelectorScreen> createState() => _OrganizerScanSelectorScreenState();
}

class _OrganizerScanSelectorScreenState extends State<OrganizerScanSelectorScreen> {
      ...
      body: StreamBuilder<List<Event>>(
        ...
        builder: (context, snapshot) {
          ...
          final events = snapshot.data!.where((e) {
            final isMine = e.organizer == _organizerName || e.organizer == 'Tech Club';
            // Allow scanning for events starting soon or currently live (e.g., within 24h window)
            final isRelevant = e.endTime.isAfter(now.subtract(const Duration(hours: 1)));
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    context.push('${AppRoutes.events}/attendance', extra: event);
                  },
                ),
              );
            },
